...
template<typename T> BLETypedCharacteristic<T>::BLETypedCharacteristic(const char *uuid, unsigned char properties) : BLEFixedLengthCharacteristic(uuid, properties, sizeof(T)) {
	T value;
