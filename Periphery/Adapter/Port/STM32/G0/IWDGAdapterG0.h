...
using AIWDG = class IWDGAdapterG0;


class IWDGAdapterG0: public IWDGAdapter<IWDG_TypeDef> {
private:
...
public:
	IWDGAdapterG0() { }
	IWDGAdapterG0(IWDG_TypeDef *iwdg, uint32 busClockHz = 32000):IWDGAdapter(iwdg, busClockHz) { }
